...
export const mysteryEncounter: SimpleTranslationEntries = {
  ...
  "choice_of_balance_negative_player_stats": "Reduce STAT by",
  "choice_of_balance_negative_enemy_stats": "Increase enemy STAT by",
  ...
  "choice_of_balance_positive_player_stats": "Increase STAT by",
  ...
  //"choice_of_balance_option_1_great_result": "A couple great tools and items!",
  //"choice_of_balance_option_1_amazing_result": "Whoa! An amazing item!",
  //"choice_of_balance_option_1_bad_result": `Oh no!@d{32}\nThe chest was trapped!
